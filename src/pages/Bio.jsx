...
export default function Bio(){
     ...
     const opacityText = useTransform(scrollY, [550, 650, 700, 750, 800, 850, 950], [0, 0.3, 0.4, 0.5, 0.65, 0.75, 1]);
     const scaleText = useTransform(scrollY, [500, 650, 750, 850, 950], [0.5, 0.6, 0.7, 0.8, 0.95]);
     ...
     const contentEn =       
        <div className={styles.content}>
            ...
            <p>   I come from the village of Kato Viannos, a very small village in the Municipality of Viannos, south of Heraklion.
            ...
            <p>   From pencils, crayons, oils and acrylics to the soft pastels that I have been using since 2018, I have tried almost all the materials.
                  Pastels are the material that gives me the most freedom and I have been using them almost exclusively in recent years.
